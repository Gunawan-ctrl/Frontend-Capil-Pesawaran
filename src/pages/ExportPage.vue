        ...
        <q-item>
          ...
          <q-item-section>
            ...
            <q-item-label caption
              >Halaman import export data penduduk Kabupaten
          ...
          <q-card class="bg-indigo-6 flex text-indigo-10">
            ...
            <q-card-section>
              ...
              <q-item-label caption class="text-white"
                >Download data dari database</q-item-label
              >
            </q-card-section>
          </q-card>
        </div>
            ...
            <q-form @submit="getDataBydate()">
              <q-card-section>
                <q-item-label class="text-weight-bold"
                  >EXPORT DATA</q-item-label
                >
                <q-item-label caption
                  >Silahkan tentukan range waktu yang di inginkan</q-item-label
                >
              </q-card-section>
...
export default {
  ...
  methods: {
    ...
    exportToCSV(data) {
      const content = [
        "Nomor KK; NIK; Nama Lengkap; Kecamatan; Desa; Jenis Kalamin;",
      ]
        .concat(
          data.map((row) => {
