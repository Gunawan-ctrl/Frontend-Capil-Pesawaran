    ...
    <div class="q-pa-md">
      <q-card class="my-card">
        <q-item>
          ...
          <q-item-section>
            <q-item-label class="text-weight-bold">Bantuan</q-item-label>
            <q-item-label caption
              >Halaman statistik data bantuan Kabupaten Pesawaran</q-item-label
            >
          </q-item-section>
        </q-item>
      </q-card>
          ...
          <q-card-section>
            <q-item-label class="text-white text-weight-bold">
              <vue3-autocounter
                ref="counter"
                :startAmount="0"
                :endAmount="`${this.penduduk_wanita}`"
                :duration="1"
                separator="."
                :autoinit="true"
              />
          ...
          <template v-slot:top>
            <div class="col">
              <q-item-section>
                <q-item-label class="text-weight-bold">Bantuan</q-item-label>
                <q-item-label caption
                  >Halaman statistik data bantuan Kabupaten
                  ...
                  <q-card class="my-card" flat bordered>
                    ...
                    >
                      ...
                      <l-marker
                        ...
                        :key="i"
                        :lat-lng="[
                          Number(d.location_latitude),
                          Number(d.location_longitude),
                        ]"
                      >
                        <l-popup>
...
import * as animationData from "./../../public/images/lottie/help.json";
